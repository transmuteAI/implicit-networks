...
class CNNBasic(torch.nn.Module): 
    ...
    def __init__(self, n_classes=10):
        ...
        self.conv1 = Conv2d(1, 128, kernel_size=(7, 7), stride=(1, 1), padding=(1, 1), bias=False)
        self.btn1 = BatchNorm2d(128, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.conv2 = Conv2d(128, 192, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2), bias=False)
        self.btn2 = BatchNorm2d(192, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.conv3 = Conv2d(192, 256, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2), bias=False)
        self.btn3 = BatchNorm2d(256, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.conv4 = Conv2d(256,256, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2), bias=False)
        self.btn4 = BatchNorm2d(256, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.conv5 = Conv2d(256,384, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2), bias=False)
        self.btn5 = BatchNorm2d(384, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.conv6 = Conv2d(384, 512, kernel_size=(5, 5), stride=(1, 1), bias=False)
        self.btn6 = BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.mplc=MaxPoolChannels(kernel_size=4)
